...
class __TwigTemplate_468f09aa385248fa750c698f9632af83bc132fe3a9a1d493d579c76af2b9ac00 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\volcanosourcedigital\\web\\themes\\contrib\\bootstrap_barrio\\templates\\content-edit\\filter-tips.html.twig");
    }
