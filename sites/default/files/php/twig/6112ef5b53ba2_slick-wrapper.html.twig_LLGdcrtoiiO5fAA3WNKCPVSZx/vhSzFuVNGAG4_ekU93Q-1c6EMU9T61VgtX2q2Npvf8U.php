...
class __TwigTemplate_d86f64b15e1e5cce11746f1b960ec6eeee687c052196e7c4310b1a50a8e88874 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25), 25, $this->source), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick-wrapper.html.twig", "C:\\xampp\\htdocs\\volcanosourcedigital\\web\\modules\\contrib\\slick\\templates\\slick-wrapper.html.twig");
    }
